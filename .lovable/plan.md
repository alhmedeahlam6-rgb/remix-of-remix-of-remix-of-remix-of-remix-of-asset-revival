...
- Guest Login: Play without linking an account.
...
- Profile Card: Shows your ID, level, likes, past rank, and battle stats (K/D, headshot rate).
- Currency System (Gold): Free currency earned by playing, used for basic items/upgrades.
- Currency System (Diamonds): Premium currency bought with real money.
- Store: The main shop for characters, skins, and crates.
- Luck Royale: A gacha system with different spinning wheels (Diamond, Gold, Weapon, Incubator) to gamble for rare skins.
- Booyah Pass (formerly Elite Pass): A tiered battle pass that gives rewards as you gain XP.
- Character System: Roster of unique characters, each with a specific active or passive ability.
- Character Link System: Unlocking characters for free by playing matches with them.
- Skill Slots: Combining one active ability and three passive abilities into a custom loadout.
- Pet System: Companions that follow you and provide an extra passive skill.
- Vault: Your inventory for clothing, weapon skins, and emotes.
- Armory: Where you equip weapon skins that actually change weapon stats (e.g., + damage, - reload speed).
...
- Loadout - Bounty Token: Gives extra loot when you get your first kill.
- Loadout - Armor Crate: Start the match with a random level helmet/vest.
...
- Ping/Marker System: Double tap to mark enemies, single tap to mark loot or locations.
...
- Armor System (Vests): Level 1 to 4 vests that reduce body damage.
- Armor System (Helmets): Level 1 to 4 helmets that reduce headshot damage.
